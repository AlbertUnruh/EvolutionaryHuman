...
class Person(Base):
    ...
    def __init__(self, *,
                 ...
                 money: typing.Annotated[typing.SupportsFloat, "MinVal[0.]"] = 0.,
        ...
        assert isinstance(sexuality, Sexuality),\
